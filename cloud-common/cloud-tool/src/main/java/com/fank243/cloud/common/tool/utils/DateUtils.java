...
public class DateUtils {
    ...
    /** 1 min **/
    private static final long MIN_1 = 60 * 1000;
    /** 5 min **/
    private static final long MIN_5 = 5 * MIN_1;
    /** 30 min **/
    private static final long MIN_30 = 30 * MIN_1;
    /** 1 hour **/
    private static final long HOUR_1 = 60 * 60 * 1000;
    /** 2 hour **/
    private static final long HOUR_2 = 2 * HOUR_1;
    /** 24 hour **/
    private static final long HOUR_24 = 24 * HOUR_1;
    /** 1 day **/
    private static final long DAY_1 = 24 * 60 * 60 * 1000;
    /** 7 day **/
    ...
    public static long compareDay(Date beginDate, Date endDate) {
        ...
        return (end.getTime() - begin.getTime()) / (DAY_1);
    }
    ...
    public static int getDiffDay(Date startDate, Date endDate) {
        long days = (endDate.getTime() - startDate.getTime()) / DAY_1;
        return (int)days;
    }
    ...
    public static String getCnDates(Date date) {
        ...
        // 365天，30天，24H,1H 毫秒值
        long oneMinute = MIN_1, oneHour = HOUR_1, oneDay = HOUR_24, oneMonth = 30 * oneDay, oneYear = 12 * oneMonth;
