...
import com.fank243.springcloud.common.constant.TimeConstant;
...
public class DateUtils {
    ...
    public static long compareDay(Date beginDate, Date endDate) {
        ...
        return (end.getTime() - begin.getTime()) / (TimeConstant.DAY_1);
    }
    ...
    public static int getDiffDay(Date startDate, Date endDate) {
        long days = (endDate.getTime() - startDate.getTime()) / TimeConstant.DAY_1;
        return (int)days;
    }
    ...
    public static String getCnDates(Date date) {
        ...
        // 365天，30天，24H,1H 毫秒值
        long oneMinute = TimeConstant.MIN_1, oneHour = TimeConstant.HOUR_1, oneDay = TimeConstant.HOUR_24,
            oneMonth = 30 * oneDay, oneYear = 12 * oneMonth;

        if (times < TimeConstant.MIN_1) {
            return "刚刚";
        }
