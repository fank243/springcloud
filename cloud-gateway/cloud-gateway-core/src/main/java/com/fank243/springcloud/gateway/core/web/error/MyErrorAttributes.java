package com.fank243.springcloud.gateway.core.web.error;///*
...
// */
//
//package com.fank243.springcloud.gateway.web.error;
//
...
//
///**
// * Default implementation of {@link ErrorAttributes}. Provides the following attributes when possible:
// * <ul>
...
// * <li>errors - Any {@link ObjectError}s from a {@link BindingResult} exception (if configured)</li>
...
//
//    private static final String ERROR_ATTRIBUTE = MyErrorAttributes.class.getName() + ".ERROR";
//
//    private final Boolean includeException;
//
//    /**
//     * Create a new {@link MyErrorAttributes} instance.
//     */
...
//     * @deprecated since 2.3.0 in favor of {@link ErrorAttributeOptions#including(Include...)}
//     */
//    @Deprecated
...
//            MergedAnnotations.from(error.getClass(), SearchStrategy.TYPE_HIERARCHY).get(ResponseStatus.class);
