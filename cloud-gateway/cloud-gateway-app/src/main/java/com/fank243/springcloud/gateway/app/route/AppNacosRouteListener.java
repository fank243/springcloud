package com.fank243.springcloud.gateway.app.route;

import com.fank243.springcloud.gateway.app.properties.AppGatewayProperties;
...
@Slf4j
@Component
public class AppNacosRouteListener extends AbstractNacosRouteListener {

    @Resource
    private AppGatewayProperties properties;
