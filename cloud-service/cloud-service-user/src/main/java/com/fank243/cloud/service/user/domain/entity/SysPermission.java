...
import com.fank243.cloud.service.user.enums.PermissionType;
import lombok.Data;
...
public class SysPermission extends BaseEntity {
    ...
    @Column(name = "enable", columnDefinition = "TINYINT(1) unsigned NOT NULL DEFAULT 0 COMMENT '是否可用(0:否，1：是)'")
